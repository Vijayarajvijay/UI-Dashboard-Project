...
function sidebar() {
  return (
   <>
   <ul className="navbar-nav bg-gradient sidebar sidebar-dark accordion   " style={{height:'920px'}} id="accordionSidebar">
           ...
           <div>
            ...
            <div className='d-flex justify-content-center gap-3 ' style={{paddingTop:'350px'}}>
                <img src={help} alt="" />
